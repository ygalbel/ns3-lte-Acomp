...
int VoipBitrate = 308;
int VideoBitrate = 1309;
int FiLesharingBitRate = 1301;
int WebBitrate = 1127;
...
void ExportGnuFile(NodeContainer ueNode)
{
        ...
        //unsigned pos = pathOut2.find("part");
        std::string str3 = pathOut2.substr (0,90); 
        std::cout<<"Path:         "<<str3;
        str3.append(".dat");
        char *fileName = (char*)str3.c_str();    
...
{
   pathOut = "/media/sf_Lte/04_29_2013/";
  int isLog = 0;
  CommandLine cmd;
