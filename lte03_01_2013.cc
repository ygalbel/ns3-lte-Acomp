...
int main (int argc, char *argv[])
{
   ...
   pathOut = "/media/sf_Lte/03_01_2013/";
  int isLog = 0;
  CommandLine cmd;
  ...
  {int w = z;
   ...
   /*   if(nodeBcurr.compare(nodeBCandstr) == 0)
      {*/
        ...
        InetSocketAddress UE = InetSocketAddress (Ipv4Address::GetAny (), ++RHPort); //UE
...
*/
        ...
        ApplicationContainer serverAppsVIDEO1 = ueServerVIDEO.Install (remoteHost);
        // UE application Sink
