...
int main (int argc, char *argv[])
{
   ...
   pathOut = "/media/sf_Lte/02_26_2013/";
  int isLog = 0;
  CommandLine cmd;
...
bitrate[3] = WebBitrate;
  ...
  //  std::cout<<"\naaaaaaa: "<<ueDevs[z].Get (v)->GetObject<LteUeNetDevice>()->GetImsi();
    ...
    //  InetSocketAddress UE = InetSocketAddress (addriClient, RHPort); //UE
     ...
     // onoffRH.SetAttribute ("PacketSize", UintegerValue (7));
      ...
      /*PacketSinkHelper sink3 ("ns3::UdpSocketFactory", Address(UE));
