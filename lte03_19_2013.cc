...
{
   pathOut = "/media/sf_Lte/03_19_2013/";
  int isLog = 0;
  CommandLine cmd;
  ...
  if(isLog == 1)
   { 
    LogComponentEnable("FlowMonitor", LogLevel(LOG_LEVEL_INFO | LOG_PREFIX_TIME| LOG_FUNCTION ));
...
//float ratio = 10;
  ...
  ApplicationContainer clientAppsHTTP1 ;
      uint16_t dlPort = 9;  // well-known echo port number
...
//UDP WORK!!!
               ...
               UdpClientHelper dlClientHelper (addressUe, ++dlPort);
